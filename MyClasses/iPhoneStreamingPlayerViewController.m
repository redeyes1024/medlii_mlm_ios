...
- (void)createStreamer
{
	...
	musicdata=[[HBAppDelegate getGlobalInfo] valueForKey:@"tmp_page_data"];
	
	NSString *pata = [[NSString alloc]init];
	
	pata = [musicdata valueForKey:@"audio_url"];
	
	//NSLog(@"pata====>%@",[pata description]);
	...
	//NSLog(@"escapedvalue====>%@",[escapedValue description]);
...
{//
	if ([button.currentImage isEqual:[UIImage imageNamed:@"btn_play.png"]])
	{
		//[downloadSourceField resignFirstResponder];
		
		[self createStreamer];
		//[self setButtonImage:[UIImage imageNamed:@"btn_pause.png"]];
		[streamer start];
		[button setImage:[UIImage imageNamed:@"btn_pause.png"] forState:UIControlStateNormal];
	}
	else
	{
		[streamer pause];
		[button setImage:[UIImage imageNamed:@"btn_play.png"] forState:UIControlStateNormal];
	}
}
-(IBAction) Back:(id)sender
{
	...
	[streamer stop];
	//[backBtn setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"btn_done_h.png"]]];
	[backBtn setBackgroundImage:[UIImage imageNamed:@"btn_done_h.png"] forState:UIControlStateNormal];
...
- (IBAction)sliderMoved:(UISlider *)aSlider
{
	if (streamer.duration)
	{
		...
		//[streamer internalSeekToTime:newSeekTime];
	}
}
